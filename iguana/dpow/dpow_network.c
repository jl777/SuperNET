        ...
        if ( bp->bestk >= 0 )
        {
            ...
            if ( bestmatches == bp->minsigs && paxbestmatches == bp->minsigs && bp->bestk >= 0 && bp->bestmask != 0 )
            {
                ...
                if ( bp->destsigsmasks[bp->pendingbestk] == bp->pendingbestmask ) // have all sigs
                {
                    ...
                    } else if ( strcmp(dp->symbol,"CHIPS") == 0  || strcmp(dp->symbol,"GAME") == 0 )printf("srcmask.[%d] %llx != bestmask.%llx\n",bp->pendingbestk,(long long)bp->srcsigsmasks[bp->pendingbestk],(long long)bp->pendingbestmask);
