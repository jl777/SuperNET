...
char NOTARY_CURRENCIES[][65] = {
    "REVS", "SUPERNET", "DEX", "PANGEA", "JUMBLR", "BET", "CRYPTO", "HODL", "BOTS", "MGW", "COQUICASH", "WLC", "KV", "CEAL", "MESH", "MSHARK", "AXO", "ETOMIC", "BTCH", "NINJA", "OOT", "CHAIN", "BNTN", "PRLPAY", "DSEC", "EQL", "ZILLA", "RFOX", "SEC", "CCL", "PIRATE", "PGT", "KMDICE", "DION", "KSB", "OUR", "ILN", "RICK", "MORTY", "HUSH3", "KOIN", "ZEXO", "K64", "THC", "COMMOD", "WLC21"
};
