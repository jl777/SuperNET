...
bits256 LP_privkeycalc(void *ctx,uint8_t *pubkey33,bits256 *pubkeyp,struct iguana_info *coin,char *passphrase,char *wifstr)
{
    ...
    if ( coin->counter == 0 )
    {
        ...
        strcpy(coin->scriptstr[0],"76a914"); init_hexbytes_noT(&coin->scriptstr[0][6],rmd160,20); strcpy(&coin->scriptstr[0][46],"88ac");
        strcpy(coin->scriptstr[1],"31"); init_hexbytes_noT(&coin->scriptstr[1][2],coin->pubkey33,33); strcpy(&coin->scriptstr[1][68],"ac");
