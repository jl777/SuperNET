...
void LP_autoprices_update(char *method,char *base,double basevol,char *rel,double relvol)
{
    ...
    if ( basevol > 0. && relvol > 0. )
    {
        ...
        for (i=0; i<num_LP_autorefs; i++)
        {
            if ( strcmp(LP_autorefs[i].rel,rel) == 0 && strcmp(base,LP_autorefs[i].base) == 0 && LP_autorefs[i].lastask < price )
            {
            ...
            else if ( strcmp(LP_autorefs[i].rel,base) == 0 && strcmp(rel,LP_autorefs[i].base) == 0 && LP_autorefs[i].lastbid > price )
            {
