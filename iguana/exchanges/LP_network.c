...
{
    char str[65],url[512],*retstr; bits256 pub25519;
#ifdef FROM_MARKETMAKER
...
#endif
    sprintf(url,"http://%s:%u/api/stats/psock?ispaired=%d&cmdchannel=%d&pubkey=%s&netid=%d",destip,destport-1,ispaired,cmdchannel,bits256_str(str,pub25519),G.netid);
