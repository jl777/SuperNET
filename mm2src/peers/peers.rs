...
pub fn initialize (netid: u16, our_public_key: bits256, preferred_port: u16, _session_id: u32) -> Result<(), String> {
...
pub fn investigate_peer (ip: &str, preferred_port: u16) -> Result<(), String> {
